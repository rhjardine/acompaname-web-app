          ...
          <div className="col-12">
            ...
            >
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    <h2> <u>¿Qué es Alzheimer? </u></h2> La enfermedad de Alzheimer es un
                    ...
                    <h2> <u>Etapas</u></h2>
                    <br></br>
                    <h3>Etapa temprana:</h3> La persona puede desenvolverse de forma
                    independiente. Es posible que pueda conducir, trabajar y
                    participar de actividades sociales. Pero, puede sentir que
                    tiene episodios de pérdida de memoria como olvidarse
                    palabras familiares o la ubicación de objetos cotidianos.
                    <br></br>
                    <br></br>
                    <h3>Etapa media:</h3> Es la fase más prolongada, puede durar muchos
                    años. Además de los síntomas anteriores puede presentar
                    desorientación, confundir palabras, cambios en su
                    ...
                    <br></br>
                    <br></br>
                    <h3>Etapa final:</h3> Las personas pierden la capacidad de responder
                    a su entorno, de llevar adelante una conversación y de
                    controlar los movimientos. A medida que la memoria y las
                    habilidades cognitivas empeoran, es posible que ocurran
                    cambios significativos en la personalidad. Los pacientes
                    requieren de ayuda en su totalidad
                    <br></br>
                    <br></br>
                    <h2> <u>¿Cómo cuidarme?</u></h2>
                    <br></br>
                    ...
                    <br></br>
                    <ul>
                    <li>Haga actividades que concuerde con algo que, siendo
                    paciente con Alzheimer, puede hacer, ejemplo: tareas
                    domésticas, jugar memoria, pintar, ordenar, visitar
                    familiares y recordar momentos con fotografías.</li>
                    <br></br>
                    <li>Seleccione actividades que puedan ser divertidas tanto para
                    usted como paciente y su familiar o cuidador.</li>
                    <br></br>
              ...
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                  <h2> <u>Pasos tras el diagnóstico</u></h2>
                    <br></br>
                    ...
                    <br></br>
                    <li>Prevenir y siempre estar atento a posibles retos
                    y problemas.</li>
                    <br></br>
                    <li>Promueva actividades que sean estimulantes y que pueda
                    disfrutar su familiar con alzhéimer.</li>
                    <br></br>
                    <li>Tener personas y objetos comunes alrededor. Puede ser útil
                    tener álbumes de fotos familiares.</li>
                    <br></br>
                    <li>Brindar recordatorios, notas, listas de tareas rutinarias o
                    instrucciones para las actividades diarias.</li>
                    <br></br>
                    <li>Ceñirse a un horario de actividades simple.</li>
                    <br></br>
                    <li>Hablar con su familiar de cualquier tema que sean eventos
                    actuales.</li>
                    <br></br>
                    <li>Tener siempre los números de emergencia guardados.</li>
                    <br></br>
                    <li>Incrementar la seguridad en la casa, para evitar
                    accidentes.</li>
                    <br></br>
                    <li>Apoyo médico, de otros familiares, conocidos o vecinos.
                    También apoyarse de ONG’s e instituciones o cuidadores
                    especializados en la materia.</li></ul> 
                  
                    <br></br>
                    <h2> <u>Actuar en cada Etapa</u></h2>
                    <br></br>
                    ...
                    <br></br>
                    <ul>
                      <li>Potenciar su independencia: que haga por sí mismo cuanto le
                    sea posible para que así no olvide sus rutinas, se mantenga
                    útil, autónomo y no decaiga su autoestima.</li>
                    <br></br>
                    <li>Ayudar al paciente a planificar: sea actividades que puede
                    ayudar a mantener activa la parte cognitiva.</li>
                    <br></br>
                    <li>Prevenir cualquier accidente.</li></ul>
                    <br></br>
                    <h3>Etapa media:</h3>
                    <br></br>
                    ...
                    <br></br>
                    <ul>
                      <li>Formar equipos familiares: que puedan ayudar al paciente
                    porque y se turnen en sus cuidados, pues para una persona
                    agota física y psicológicamente.</li>
                    <br></br>
                    <li>Buscar centros de ayuda o cuidadores: que les permitan
                    cuidar al paciente por algunas horas.</li>
                    <br></br>
                    <li>Centros de estimulación cognitiva: buscar lugares donde el
                    paciente pueda hacer ejercicio físico y mental.</li></ul>
                    <br></br>
                    <h3>Etapa final:</h3>
                    <br></br>
                    ...
                    <br></br>
                    <ul>
                      <li>Apoyarse en familia: se deben turnar con los cuidados del
                    paciente, ya que requieren de más atención. También
                    establecer planes de emergencia.</li>
                    <br></br>
                    <li>Buscar apoyo psicológico: para familiares y cuidadores
                    porque la enfermedad desgasta mentalmente y puede presentar
                    síndrome del cuidador principal.</li>
                    <br></br>
                    <li>Buscar apoyo médico: no solo para el paciente sino también
                    para familiares porque agota físicamente para ellos.</li></ul>
                    
                    <br></br>
                    <h2> <u>Síndrome del cuidador</u></h2>
                    <br></br>
              ...
              <div className="accordion-item">
                ...
                >
                  ...
                  <br></br>
                  <h6>Piedad. Documental sobre el alzhéimer. Por Otto Roca.</h6>
                  <br></br>
                  <h6>Still Alice. Película sobre la vida de una profesora tras ser diagnosticada con alzheimer. Por Richard Glatzer, Wash Westmoreland.</h6>
                  <br></br>
                  <h6>Bicicleta, cuchara y manzana. Documental sobre la vida del político catalán, Pasqual Maragall, y su enfermedad alzhéimer. Por Carles Bosch.</h6>
